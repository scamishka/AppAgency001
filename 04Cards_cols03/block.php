...
$data = array(
    'code' => '04Cards_cols03',
    'fields' => array(
        'NAME' => 'Блок карточек в колонки на сером фоне',
        'DESCRIPTION' => '04Cards_cols03',
        'SECTIONS' => 'Типовой сайт агенства недвижимости',
        'PREVIEW' => 'https://abcdef.tmweb.ru/AppAgency001/04Cards_cols03/preview.jpg',
        'CONTENT' => '
            <section class="exclusive-list block-view">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class=" cetacs-block_cards-cols_title heading-dark main-slider__h2">Эксклюзивные Предложения</h2>
    ...
    'manifest' => array(
        'assets' => array (
            'css' => array (
                'https://abcdef.tmweb.ru/AppAgency001/04Cards_cols03/style.css',
                'https://abcdef.tmweb.ru/AppAgency001/04Cards_cols03/owl.carousel.css'

            ),
            'js' => array (
                'https://abcdef.tmweb.ru/AppAgency001/04Cards_cols03/owl.carousel.js',
                'https://abcdef.tmweb.ru/AppAgency001/04Cards_cols03/script.js'
            ),
        ),
        'cards' => array(
