...
$data = array(
    ...
    'fields' => array(
        ...
        'DESCRIPTION' => '08Footer21',
        'SECTIONS' => 'Персональный риелтор',
        'subtype' => 'form',
        'PREVIEW' => 'https://abcdef.tmweb.ru/AppAgency001/08Footer21/preview.jpg',
        'CONTENT' => '
           <footer id="contacts21" class="cetacs-block_footer_bg contacts">
                <div class="container">
    ...
    'manifest' => array(
        ...
        'assets' => array (
            'css' => array (
                'https://abcdef.tmweb.ru/AppAgency001/08Footer21/style.css'
            ),
            'ext' => array (
                'landing_form'
            ),
