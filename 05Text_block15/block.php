...
$data = array(
    ...
    'fields' => array(
        ...
        'DESCRIPTION' => '05Text_block15',
        'SECTIONS' => 'Юрист по недвижимости',
        'PREVIEW' => 'https://abcdef.tmweb.ru/AppAgency001/05Text_block15/preview.jpg',
        'CONTENT' => '
                       ...
                       <div class="cetacs-block_text-block_block-img col-md-4">
                            <span class="img-thumbnail">
                                <img alt="" class="cetacs-block_text-block_img img-responsive"
                                     src="https://abcdef.tmweb.ru/AppAgency001/05Text_block15/image.jpg">
                            </span>
                        </div>
    ...
    'manifest' => array(
        'assets' => array (
            'css' => array (
                'https://abcdef.tmweb.ru/AppAgency001/05Text_block15/style.css'
            ),
            'js' => array (
                'https://abcdef.tmweb.ru/AppAgency001/05Text_block15/script.js'
            ),
        ),
        'nodes' => array(
