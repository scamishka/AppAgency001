...
//$data  = '<div>test</div>';
$data = array(
    'code' => '01Header_left_logo_contacts11',
    'fields' => array(
        'NAME' => 'Шапка сайта с логотипом слева и контактами',
        'DESCRIPTION' => '01Header_left_logo_contacts11',
        'SECTIONS' => 'Юрист по недвижимости',
        'PREVIEW' => 'https://abcdef.tmweb.ru/AppAgency001/01Header_left_logo_contacts11/preview.jpg',
        'CONTENT' => '
                        <header id="jurist-header11" data-sticky-top-spacing="- 51" class="sticky">
    <div class="container">
        <div class="header">
            <div class="row">
                <div class="header-left col-md-5 col-xs-8">
                    <a href="/" class="header_block-logo-link logo fc-prm">
                        ...
                        <h2 class="header_block-logo_logo_title-text title-text">
                            Юрист Недвижимость Краснодар
                        </h2>
                        <p class="header_block-logo_logo_subtitle-text subtitle-text">
                            Гарантия чистоты и безопасностио сделок с имуществом!
                        </p>
                            ...
                            <ul class="menu_top">
                                <li class="header_block_contacts header-contact hidden-md-down">
                                    <a class="header_block-item_link fc-prm" href="#">
                                        ...
                                        <span class="header_block-item">Краснодар, улица Красная, дом 11</span>
                                    </a>
                                </li>
                                <li class="header_block_contacts header-contact hidden-md-down">
                                    <a class="header_block-item_link fc-prm" href="tel:+70001000010">
                                        <i class="header_block-item_icon fa fa-phone"></i>
                                        <span class="header_block-item">+7 000 100 00 10 </span>
                                    </a>
                                </li>
                            </ul>
                        </div>
    ...
    'manifest' => array (
        'assets' => array (
            'css' => array (
                ...
                'https://abcdef.tmweb.ru/AppAgency001/01Header_left_logo_contacts11/slicknav.css',
                'https://abcdef.tmweb.ru/AppAgency001/01Header_left_logo_contacts11/style.css',
            ),
            'js' => array (
                'https://abcdef.tmweb.ru/AppAgency001/01Header_left_logo_contacts11/jquery.slicknav.js',
                'https://abcdef.tmweb.ru/AppAgency001/01Header_left_logo_contacts11/slicknav.js',
                ...
                'presets' => array(
                    'phone' => array (
                        ...
                        'html' => '<li class="header_block_contacts header-contact hidden-md-down" data-card-preset="phone">
                                    <a class="header_block-item_link fc-prm" href="tel:+79581008542">
                                        <i class="header_block-item_icon fa fa-phone"></i>
                    ...
                    'email' => array (
                        ...
                        'html' => '<li class="header_block_contacts header-contact hidden-md-down" data-card-preset="email">
                                    <a class="header_block-item_link fc-prm" href="mailto:info@increza.ru">
                                        <i class="header_block-item_icon fa fa-envelope-o"></i>
                                        <span class="header_block-item">info@increza.ru</span></a>
                                </li>',
                        'values' => array (
                            '.header_block-item_icon' => array(
                                'type' => 'icon',
