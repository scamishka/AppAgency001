...
$data = array(
    ...
    'fields' => array(
        ...
        'DESCRIPTION' => '02Menu_right31',
        'SECTIONS' => 'Ипотечный брокер',
        'PREVIEW' => 'https://abcdef.tmweb.ru/AppAgency001/02Menu_right31/preview.jpg',
        'CONTENT' => '
            <div id="menu_right31" class="cetacs-block_menu page_header bgc-prm">
                                ...
                                <ul id="main-menu" class=" main-menu">
                                    ...
                                    <li class="cetacs-block_menu_item">
                                        <a class="cetacs-block_menu_item_link" href="#about">
                                            <span class="cetacs-block_menu_item_title">Экономия</span>
                                        </a>
                                    </li>
                                    <li class="cetacs-block_menu_item">
                                        <a class="cetacs-block_menu_item_link" href="#">
                                            <span class="cetacs-block_menu_item_title">Бонусы</span>
                                        </a>
                                    </li>
                                    <li class="cetacs-block_menu_item">
                                        <a class="cetacs-block_menu_item_link" href="#review">
                                            <span class="cetacs-block_menu_item_title">Партнёры</span>
                                        </a>
                                    </li>
                                    <li class="cetacs-block_menu_item">
                                        <a class="cetacs-block_menu_item_link" href="#contacts">
                                            <span class="cetacs-block_menu_item_title">Стоимость</span>
                                        </a>
                                    </li>
                                    <li class="cetacs-block_menu_item">
    ...
    'manifest' => array(
        'assets' => array (
            'css' => array (
                'https://abcdef.tmweb.ru/AppAgency001/02Menu_right31/style.css'
            ),
        ),
        'cards' => array(
