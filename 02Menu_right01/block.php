...
$data = array(
    ...
    'fields' => array(
        ...
        'DESCRIPTION' => '02Menu_right01',
        'SECTIONS' => 'Типовой сайт агенства недвижимости',
        'PREVIEW' => 'https://abcdef.tmweb.ru/AppAgency001/02Menu_right01/preview.jpg',
        'CONTENT' => '
            <div id="menu_right01" class="cetacs-block_menu page_header bgc-prm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12">
                                <ul id="main-menu" class=" main-menu">
                                    ...
                                    <li class="cetacs-block_menu_item">
                                        <a class="cetacs-block_menu_item_link" href="#">
                                            <span class="cetacs-block_menu_item_title">Информация</span>
                                        </a>
                                    </li>
                                    <li class="cetacs-block_menu_item">
                                        <a class="cetacs-block_menu_item_link" href="#">
                                            <span class="cetacs-block_menu_item_title">Новости</span>
                                        </a>
                                    </li>
                                    <li class="cetacs-block_menu_item">
                                        <a class="cetacs-block_menu_item_link" href="#">
    ...
    'manifest' => array(
        'assets' => array (
            'css' => array (
                'https://abcdef.tmweb.ru/AppAgency001/02Menu_right01/style.css'
            ),
        ),
        'cards' => array(
