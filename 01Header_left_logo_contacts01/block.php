...
//$data  = '<div>test</div>';
$data = array(
    'code' => '01Header_left_logo_contacts01',
    'fields' => array(
        'NAME' => 'Шапка сайта с логотипом слева и контактами',
        'DESCRIPTION' => '01Header_left_logo_contacts01',
        'SECTIONS' => 'Типовой сайт агенства недвижимости',
        'PREVIEW' => 'https://abcdef.tmweb.ru/AppAgency001/01Header_left_logo_contacts01/preview.jpg',
        'CONTENT' => '
                        <header id="header-agency01" data-sticky-top-spacing=\'-51\' class="sticky">
                            <div class="container">
                                <div class="header">
                                    <div class="row">
    ...
    'manifest' => array (
        'assets' => array (
            'css' => array (
                ...
                'https://abcdef.tmweb.ru/AppAgency001/01Header_left_logo_contacts01/style.css',


            ),
            'js' => array (
                'https://abcdef.tmweb.ru/AppAgency001/01Header_left_logo_contacts01/jquery.slicknav.js',
                'https://abcdef.tmweb.ru/AppAgency001/01Header_left_logo_contacts01/slicknav.js',
